...
# cv2.ellipse(image, (256, 256), (100, 50), 0, 30, 360, (0, 255, 0), 2)  # Green ellipse rotated by 45 degrees

# Step 8: Draw a polygon
# cv2.polylines(image, [pts], isClosed, color, thickness)
# pts = np.array([[50, 300], [100, 350], [50, 400], [100, 450], [50, 500]])
# cv2.polylines(image, [pts], isClosed=True, color=(0, 0, 255), thickness=2)  # Red open polygon
...
cv2.putText(image, "Hello, OpenCV!", (50, 500), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 0), 8)
